            ...
            <nav className="navBar">
                    ...
                    <div className={isLight ? 'modalOpen' : 'modalOpen modalOpenNight'}>
                        ...
                        <div className="linksPage">
                            <a href="#proyects"
                                ...
                                onClick={handleModal}>
                                    {text[isSpa].navBar.proyects}
                            </a>
                            <a href="#about"
                                className="linksModal"
                                onClick={handleModal}>
                                    {text[isSpa].navBar.about}
                                </a>
                            <a href="#contact"
                                className="linksModal"
                                onClick={handleModal}>
                                    {text[isSpa].navBar.contact}
                            </a>
                        </div>
                ...
                <div className={isLight ? 'desktop' : 'desktop backgroundBarNight'}>
                    ...
                    <div className="linksPageDesktop">
                            <a href="#proyects"
                                className={isLight ? 'linksDesktop' : 'linksDesktop textBarNight'} >
                                    {text[isSpa].navBar.proyects}
                            </a>
                            <a href="#about"
                                className={isLight ? 'linksDesktop' : 'linksDesktop textBarNight'} >
                    ...
                    <div className="externalLinksDesktop">
                            <div>
                                <a href="https://www.linkedin.com/in/juanmzabala/"
                                target="_blank"
                                className="containerLinkDesktop">
                                    <BsLinkedin size="2em"/>
                                </a>
                            </div>
                            <div>
            ...
            <nav className="navBar">
                <div className={isLight ? 'mobile' : 'mobile backgroundBarNight'}>
                    <a href="#hello" className="logo">
                        <img src={isLight ? "bigLogoJuanZabala.svg" : "bigLogoJuanZabalaWhite.svg"}
                            alt="logo" />
                    </a>
                    <div className={isLight ? 'options' : 'options optionsNight'}
                        onClick={handleModal}>
                            <ImMenu size="2em"/>
                    </div>
                </div>
